...
INSERT OR IGNORE INTO config VALUES ('influx_db_start_relative', 1, 'number', 'If you have an ongoing brew or fermentation process only values related to this process will be shown in the graph. Additionally you can define in hours how far the time series should reach in the past. The earliest time of both information defines when the data series starts.', NULL );
