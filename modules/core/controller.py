...
class KettleController(ControllerBase, ActorController, SensorController):
    ...
    @staticmethod
    def chart(kettle):
        result = [{"name": "Temp", "data_type": "sensor", "data_id": kettle.sensor},
                  {"name": "Target Temp", "data_type": "kettle", "data_id": kettle.id}]
...
class FermenterController(ControllerBase, ActorController, SensorController):
    ...
    @staticmethod
    def chart(fermenter):
        result = [{"name": "Temp", "data_type": "sensor", "data_id": fermenter.sensor},
                  {"name": "Target Temp", "data_type": "fermenter", "data_id": fermenter.id}]
        return result
